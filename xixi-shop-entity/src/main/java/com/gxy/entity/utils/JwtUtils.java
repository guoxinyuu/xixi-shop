...
public class JwtUtils {
    ...
    public static void main(String[] args) {
        ...
        String token = com.gxy.entity.utils.JwtUtils.createUserToken(id,"zhangsan",jwtSalt);
        System.out.println(token);
        System.out.println("验证码token是否正确 正确：实体对象，错误：null "+ com.gxy.entity.utils.JwtUtils.verifyToken(token, jwtSalt));
        System.out.println("id值:"+ com.gxy.entity.utils.JwtUtils.getAudience(token));
        System.out.println("盐值:"+ com.gxy.entity.utils.JwtUtils.getClaimByName(token, "jwtSalt"));
        System.out.println("获取token中的用户名:"+ com.gxy.entity.utils.JwtUtils.getClaimByName(token,"userName"));
